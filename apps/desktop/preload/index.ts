...
const bridge: DesktopBridge = Object.freeze({
  ...
  checkAllSources: runId => ipcRenderer.invoke("desktop:check-all-sources",runId),
  cancelAllSourceChecks: () => ipcRenderer.invoke("desktop:cancel-all-source-checks"),
  onSourceCheckProgress: listener => {const handler=(_event:Electron.IpcRendererEvent,value:Parameters<typeof listener>[0])=>listener(value);ipcRenderer.on("desktop:source-check-progress",handler);return ()=>ipcRenderer.removeListener("desktop:source-check-progress",handler);},
  ...
  hideResumeVersion: (workspaceId, versionId) => ipcRenderer.invoke("desktop:hide-resume-version", workspaceId, versionId),
  ...
  hideResearchReport: (workspaceId, reportId) => ipcRenderer.invoke("desktop:hide-research-report", workspaceId, reportId),
