...
_INSTRUCTIONS = (
    ...
    "(role/location/salary/track/type), search_jobs. "
    ...
    "or apply URLs. Use get_jobs / get_job_details for structured job "
    ...
    "Only call get_jobs / get_job_details when the user explicitly asks "
    ...
    "In no-resume mode never fabricate a match percentage or resume-based claim. "
    "Set use_profile=false when the user says they do not want to use a resume; "
    "the Server skips profile loading entirely for that search. "
