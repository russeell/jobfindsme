...
writeFileSync(
  ...
  JSON.stringify({ name: "jobfindsme-desktop", version: "0.1.0", jobfindsmePreview:previewBuild, build:buildInfo.label, previewUserData:buildInfo.previewUserData, main: "dist-electron/main/index.js" }),
);
