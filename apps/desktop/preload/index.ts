...
const bridge: DesktopBridge = Object.freeze({
  ...
  clearCurrentResume: (workspaceId) => ipcRenderer.invoke("desktop:clear-current-resume",workspaceId),
  getSearchPreferences: (workspaceId) => ipcRenderer.invoke("desktop:get-search-preferences",workspaceId),
  saveSearchPreferences: (input) => ipcRenderer.invoke("desktop:save-search-preferences",input),
  ...
  cancelResearchChat: () => ipcRenderer.invoke("desktop:cancel-research-chat"),
  onResearchChatDelta: listener => {const handler=(_event:Electron.IpcRendererEvent,delta:string)=>listener(delta);ipcRenderer.on("desktop:research-chat-delta",handler);return ()=>ipcRenderer.removeListener("desktop:research-chat-delta",handler);},
