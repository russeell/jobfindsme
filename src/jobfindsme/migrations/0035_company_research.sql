CREATE TABLE research_reports_v3 (
...
CREATE TABLE research_evidence_v3 (
    ...
    FOREIGN KEY (report_id) REFERENCES research_reports_v3(report_id) ON DELETE CASCADE,
...
INSERT INTO research_reports_v3 SELECT * FROM research_reports;
INSERT INTO research_evidence_v3 SELECT * FROM research_evidence;
DROP TABLE research_evidence;
DROP TABLE research_reports;
ALTER TABLE research_reports_v3 RENAME TO research_reports;
ALTER TABLE research_evidence_v3 RENAME TO research_evidence;
