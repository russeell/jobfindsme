...
const bridge: DesktopBridge = Object.freeze({
  ...
  listResearchChats: (workspaceId) => ipcRenderer.invoke("desktop:list-research-chats",workspaceId),
  saveResearchChat: (input) => ipcRenderer.invoke("desktop:save-research-chat",input),
